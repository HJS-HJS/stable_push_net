...
class HybridAstarPushPlanner(object):
    ...
    def _get_stable_minimum_radius(self, depth_image, contact_point):
        ...
        # results = self._stable_determinator.get_push_results(depth_image, contact_point)
        ...
        left_min_radius, right_min_radius = self._stable_determinator.get_push_results(depth_image, contact_point)
